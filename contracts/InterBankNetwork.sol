...
contract InterBankNetwork {
    ...
    bytes32 name;
    uint256 public constant MIN_FUNDING_AMOUNT = 0.0001 ether;
    ...
    require(msg.value >= MIN_FUNDING_AMOUNT,"Bank cannot be added in this network until funding of 0.0001 ETH");
